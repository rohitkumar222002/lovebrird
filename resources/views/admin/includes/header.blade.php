    ...
    <div class="navbar-header">
        ...
        <div class="navbar-logo-box">
            <a href="{{route('admin.dashboard')}}" class="logo logo-dark">
                <span class="logo-sm">
                    <img src="{{asset('admin/images/logo-sm.png')}}" alt="logo-sm-dark" height="20">
                </span>
                <span class="logo-lg">
                    <img src="{{asset('admin/images/logo-dark.png')}}" alt="logo-dark" height="18">
                </span>
            </a>
                    ...
                    <!-- <div class="dropdown-menu dropdown-menu-start dropdown-menu-lg-widest dropdown-menu-widest dropdown-menu-animated bg-primary-subtle overflow-hidden">
                        <div class="dropdown-row justify-content-center">
                            ...
                            <div class="dropdown-col">
                                ...
                                <div class="mt-3">
                                    <a href="#" class="btn btn-dark btn-wider">Login</a>
                                </div>
                            </div>
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="dropdown d-inline-block">
                    <button type="button" class="btn btn-sm top-icon p-0" id="page-header-user-dropdown"
                        ...
                        <img class="rounded avatar-2xs p-0" src="{{asset('admin/images/users/avatar-1.png')}}"
                            alt="Header Avatar">
                    </button>
                    <div
                        ...
                        <div class="card border-0">
                            ...
                            <div class="card-body p-0">
                                <div class="grid-nav grid-nav-flush grid-nav-action grid-nav-no-rounded">
                                    <div class="grid-nav-row">
                                        <a href="{{route('admin.profile')}}" class="grid-nav-item">
